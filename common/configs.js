...
module.exports = {
	// Fill in whether the current machine is localhost.
	// This is used to determine whether we should post reviews to slack or not
	...
	// Port on which the web server will be started
	port: function () {
